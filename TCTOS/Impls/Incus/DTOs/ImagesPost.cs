...
{
    [JsonPropertyName("aliases")] public ImageAlias[]? Aliases { get; set; }
    ...
    [JsonPropertyName("source")] public ImagesPostSource? Source { get; set; }
}
...
public sealed record ImagesPostSource
{
    ...
    [JsonPropertyName("secret")] public string? Secret { init; get; }
    ...
    [JsonPropertyName("url")] public string? Url { init; get; }
}