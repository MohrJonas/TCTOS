...
public sealed record Image
{
    ...
    public ImageAlias[]? Aliases { init; get; }
    
    [JsonPropertyName("architecture")]
    public string? Architecture { init; get; }
    
    [JsonPropertyName("auto_update")]
    public bool? AutoUpdate { init; get;  }
    
    [JsonPropertyName("cached")]
    public bool? Cached { init; get; }
    ...
    public DateTime? LastUsedAt { init; get; }
    
    [JsonPropertyName("profiles")]
    public string[]? Profiles { init; get; }
    
    [JsonPropertyName("project")]
    public string? Project { init; get; }
    
    [JsonPropertyName("properties")]
    public Dictionary<string, string>? Properties { init; get; }
    
    [JsonPropertyName("public")]
    public bool? Public { init; get; }
    ...
    public ImageSource? ImageSource { init; get; }
    
    [JsonPropertyName("uploaded_at")]
    public DateTime? UploadedAt { init; get; }
}